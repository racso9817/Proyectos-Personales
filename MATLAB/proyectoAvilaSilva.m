...
%% funciones de transferencia incluida la de la aproximacion de pade
...
figure();
hold on
title('Aproximacion de Pade y funcion original')
step(Gppade)
step(Gp)
...
syms z
f=(-0.0002173*z^3 + 0.0001064*z^2 + 0.0001942*z + 2.692*10^-08)/(z^4 - 2.318*z^3 + 1.745*z^2 - 0.4235*z - 4.702*10^-17)
